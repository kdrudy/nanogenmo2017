package com.kyrutech.nanogenmo2017.dl4j;
...
public class GravesLSTMCharModellingExample {
	public static void main( String[] args ) throws Exception {
		...
		CharacterIterator iter = getPlotIterator(miniBatchSize,exampleLength);
	...
	public static CharacterIterator getPlotIterator(int miniBatchSize, int sequenceLength) throws Exception {
		char[] validCharacters = CharacterIterator.getMinimalCharacterSet();	//Which characters are allowed? Others will be removed
		return new CharacterIterator("files/plots", Charset.forName("UTF-8"),
				miniBatchSize, sequenceLength, validCharacters, new Random(12345));
	}
